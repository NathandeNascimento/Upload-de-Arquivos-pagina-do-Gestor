    ...
    <style>
        *{margin:0px;
        ...
        @media(max-width:416px){
            .mar-l{margin-left:0%;}
            .container{margin:15% 5%; width: 90%;}
...
<body>
    ...
    <form action="./email/env_email2.php" method="post">
   
    <div class="col-md-5 mar-l" >
    ...
    <textarea name="msg1" id="" cols="30" rows="10" class="form-control " 
    placeholder="OLá!!!
